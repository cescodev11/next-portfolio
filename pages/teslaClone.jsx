    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            I cloned the tesla website to the best of my ability while
            practicing style components. This clone was built using react and
            CSS for simple styling.
          </p>
          <a
            href="https://github.com/Carlosescobar2/tesla-clone"
            target="_blank"
            rel="noreferrer"
          >
